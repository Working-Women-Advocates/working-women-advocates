  ...
  return (
    <main className="mdl-layout__content">
      <div id="landing-page" className="page-content">
        ...
        <h6 className="mdl-cell mdl-cell--6-col">If you are experiencing difficulties at work, you may need an advocate. We are here for you and respect your privacy.</h6>
