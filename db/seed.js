...
const seedIssues = () => db.Promise.map([
  ...
  { username: 'SuperGirl', contact_method: 'Skype', skype: 'supergirl', description: 'sexual harrasment', advocate_id: 1 },
  { username: 'Lois Lane', contact_method: 'SMS Text', text: '555-555-5554', description: 'discrimination', advocate_id: 1 },
